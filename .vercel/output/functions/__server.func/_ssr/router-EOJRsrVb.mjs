...
//#region node_modules/.nitro/vite/services/ssr/assets/router-EOJRsrVb.js
...
var styles_default = "/assets/styles-CAyA3OmZ.css";
var APP_NAME = "Eastside Legends Sim";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Prototype NFL simulation sportsbook and fantasy tracker. Spreads snapshot only. No real money."
			},
			{
				name: "theme-color",
				content: "#0B2E24"
...
*/
var fetchEspnScoreBoard = createServerFn({ method: "GET" }).handler(createSsrRpc("47c718c39956d0bb68790277e3cb4e146f159400fd3a1213f9476335e50e0e09"));
/**
...
*/
var IDLE = unavailableScoreBoard();
/**
...
//#endregion
export { peekScoreBoard as i, Route as n, loadScoreBoard as r, router_exports as t };
