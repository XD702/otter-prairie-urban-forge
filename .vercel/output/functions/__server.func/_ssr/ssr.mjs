...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-fjbj-jJb.mjs");
...
var manifest = { "47c718c39956d0bb68790277e3cb4e146f159400fd3a1213f9476335e50e0e09": {
	functionName: "fetchEspnScoreBoard_createServerFn_handler",
	importer: () => import("./fetch-espn-BOyrkkp1.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-EOJRsrVb.mjs").then((n) => n.t),
